...
export interface ApiMarketMarket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['EUR ', 'GBP ', 'CHF']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    defaultLocale: Schema.Attribute.Enumeration<['de ', 'en ', 'fr']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    theme: Schema.Attribute.Enumeration<['default', 'luxury ', 'dark']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPlpExperiencePlpExperience extends Struct.SingleTypeSchema {
  collectionName: 'plp_experiences';
  info: {
    displayName: 'plpExperience';
    pluralName: 'plp-experiences';
    singularName: 'plp-experience';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    bannerConfig: Schema.Attribute.Component<'plp.banner-configuration', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plp-experience.plp-experience'
    >;
    publishedAt: Schema.Attribute.DateTime;
